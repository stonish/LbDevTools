...
macro(init_search_path)
    ...
    # handle special LBENV_CURRENT_WORKSPACE environment variable
    if(IS_DIRECTORY "$ENV{LBENV_CURRENT_WORKSPACE}")
        # just to make sure we have BINARY_TAG as variable or from the environment
        ...
        list(PREPEND CMAKE_PREFIX_PATH ${workspace_dirs})
    endif()
...
function(_internal_find_projects projects_var tools_var config_file)
    ...
    string(REGEX MATCH "[\r\n][ \t]*(gaudi_|athena_)project[ \t]*\\(([^)]+)\\)" match ${config_file_data})
    set(match ${CMAKE_MATCH_2})
    if(NOT match)
        message(AUTHOR_WARNING "${config_file} does not contain gaudi_project or athena_project")
    endif()
