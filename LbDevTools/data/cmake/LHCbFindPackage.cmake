...
macro(lhcb_find_package project)
    ...
    if(CMAKE_SOURCE_DIR STREQUAL PROJECT_SOURCE_DIR
        ...
        if(DEFINED ${project}_EXACT_VERSION AND NOT DEFINED ${project}_DIR)
            set(_require_exact_version TRUE)
        else()
            set(_require_exact_version FALSE)
        endif()
        if(_require_exact_version)
        ...
        find_package(${_args})
        unset(_args)
        if(_require_exact_version AND ${project}_FOUND AND NOT ${project}_VERSION STREQUAL ${project}_EXACT_VERSION)
