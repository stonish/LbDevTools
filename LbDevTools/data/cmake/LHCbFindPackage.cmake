...
macro(lhcb_find_package project)
    ...
    if(CMAKE_SOURCE_DIR STREQUAL PROJECT_SOURCE_DIR
        ...
        set(_args ${ARGV})
        if(DEFINED ${project}_EXACT_VERSION AND NOT DEFINED ${project}_DIR)
            set(_${project}_require_exact_version TRUE)
        else()
            set(_${project}_require_exact_version FALSE)
        endif()
        if(_${project}_require_exact_version)
        ...
        find_package(${_args})
        unset(_args)
        if(_${project}_require_exact_version AND ${project}_FOUND AND NOT ${project}_VERSION STREQUAL ${project}_EXACT_VERSION)
            message(FATAL_ERROR "Version mismatch: requested ${project}/${${project}_EXACT_VERSION} exact match but found ${${project}_VERSION}")
        endif()
	list(APPEND LHCB_PROJECTS_FOUND ${project})
        unset(_${project}_require_exact_version)
